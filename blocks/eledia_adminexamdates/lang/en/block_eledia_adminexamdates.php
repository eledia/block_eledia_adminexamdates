...
$string['configure_description'] = 'Here you can configure the exam schedule management.</br>
At least one exam room must be configured: <a class="btn btn-primary m-3" href="/blocks/eledia_adminexamdates/manageroomconfig.php">Configure exam rooms</a>';
...
$string['progressbar_update_course'] = 'Changing the exam date - updating the course on the exam system.';
...
$string['manage_roomconfig'] ='Manage exam room config';
$string['addnewroomconfig'] ='Add new exam room config';
$string['editaroomconfig'] ='Edit an exam room config';
$string['deleteroomconfigconfirm'] = 'Are you sure you want to delete this exam room config?';
$string['roomconfigadded'] = 'Exam room config added';
$string['roomconfigdeleted'] = 'Exam room config deleted';
$string['roomconfig_roomid'] = 'Room ID';
$string['roomconfig_name'] = 'Exam room name';
$string['roomconfig_capacity'] = 'Room capacity';
$string['roomconfig_color'] = 'Room Color';
$string['roomconfig_specialroom'] = 'Special Room';
$string['roomconfig_roomid_help'] = 'Enter a unique room-ID, e.g. \'ER1\' for exam room 1.';
$string['roomconfig_name_help'] = 'Exam room name,e.g. \'exam room 1\'';
$string['roomconfig_capacity_help'] = 'Enter the room capacity, this is the maximum number of exam participants in this room, e.g. \'100\'.';
$string['roomconfig_color_help'] = 'Enter the color of this room displayed in the calendar as an RGB color value, e.g. \'#3F51B5\'.';
$string['roomconfig_specialroom_help'] = 'Is this a room without participant capacity, e.g. “administrative office” or “final control room”?';
$string['settings_eledia_adminexamdates'] = 'Settings exam dates administration';
$string['backtoblocksetting'] = 'Back to exam dates administration';
$string['no_roomconfig'] = 'Please configure at least one exam room with a participant capacity!';
